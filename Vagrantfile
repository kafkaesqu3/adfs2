...
Vagrant.configure("2") do |config|
  config.vm.define "dc" do |cfg|
    ...
    # disables annoying prompt aboig enabling
    ...
    cfg.vm.network :private_network, ip: "192.168.30.2", gateway: "192.168.30.1"

    cfg.vm.provision "shell", path: "scripts/fix-second-network.ps1", privileged: false, args: "192.168.30.2"
  ...
  config.vm.define "adfs2", autostart: false do |cfg|
    ...
    cfg.vm.network :forwarded_port, guest: 22, host: 2222, id: "ssh", auto_correct: true
    cfg.vm.network :forwarded_port, guest: 3389, host: 3389, id: "rdp", auto_correct: true
    cfg.vm.network :private_network, ip: "192.168.30.3", gateway: "192.168.30.1", dns: "192.168.30.2"

    cfg.vm.provision "shell", path: "scripts/fix-second-network.ps1", privileged: false, args: "-ip 192.168.30.3 -dns 192.168.30.2"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
    cfg.vm.provision "reload"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
  ...
  config.vm.define "web", autostart: false do |cfg|
    ...
    cfg.vm.network :private_network, ip: "192.168.30.4", gateway: "192.168.30.1", dns: "192.168.30.2"

    cfg.vm.provision "shell", path: "scripts/fix-second-network.ps1", privileged: false, args: "-ip 192.168.30.4 -dns 192.168.30.2"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
  ...
  config.vm.define "ps", autostart: false do |cfg|
    ...
    cfg.vm.network :forwarded_port, guest: 22, host: 2222, id: "ssh", auto_correct: true
    cfg.vm.network :forwarded_port, guest: 3389, host: 3389, id: "rdp", auto_correct: true
    cfg.vm.network :private_network, ip: "192.168.30.9", gateway: "192.168.30.1"

    cfg.vm.provision "shell", path: "scripts/fix-second-network.ps1", privileged: false, args: "-ip 192.168.30.9 -dns 192.168.30.2"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
    cfg.vm.provision "reload"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
  ...
  config.vm.define "ts", autostart: false do |cfg|
    ...
    cfg.vm.network :forwarded_port, guest: 22, host: 2222, id: "ssh", auto_correct: true
    cfg.vm.network :forwarded_port, guest: 3389, host: 3389, id: "rdp", auto_correct: true
    cfg.vm.network :private_network, ip: "192.168.30.15", gateway: "192.168.30.1"

    cfg.vm.provision "shell", path: "scripts/fix-second-network.ps1", privileged: false, args: "-ip 192.168.30.15 -dns 192.168.30.2"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
    cfg.vm.provision "reload"
    cfg.vm.provision "shell", path: "scripts/provision.ps1", privileged: false
    cfg.vm.provision "reload"
